-- Tüm kullanıcıları döndüren güvenli RPC fonksiyonu.
-- SECURITY DEFINER sayesinde auth.users tablosuna erişir.
...
-- Admin listesini döndüren güvenli RPC fonksiyonu.
...
-- Authenticated kullanıcıların bu fonksiyonları çağırmasına izin ver
