    ...
    <AnimatePresence mode="wait">
      {open && (
        ...
        >
          ...
          <motion.div
            className="relative w-full max-w-7xl max-h-[92vh] flex flex-col rounded-[2rem] md:rounded-[2.5rem] border border-border/20 bg-foreground/5 shadow-[0_0_100px_-20px_rgba(0,0,0,0.5)] overflow-hidden backdrop-blur-xl ring-1 ring-white/5"
          ...
          >
            ...
            {/* Elegant Header */}
            <div className="flex items-center justify-between px-6 md:px-10 py-6 md:py-8 border-b border-border/20 bg-white/[0.02]">
              <div className="flex items-center gap-4 md:gap-6">
                <div className="relative group">
                  ...
                  <div className="relative p-3 md:p-4 bg-foreground/5 rounded-xl md:rounded-2xl ring-1 ring-white/10 shadow-2xl transition-transform duration-500 group-hover:scale-110">
                    <Sparkles className="h-5 w-5 md:h-7 md:w-7 text-primary" />
                  </div>
                </div>
                <div>
                  <h2 className="text-xl md:text-4xl font-display font-black tracking-tight text-foreground mb-0.5 md:mb-1">
                    Refik Keşif ve İnşâ
                  </h2>
              ...
              <motion.button
                onClick={onClose}
                className="group relative p-2.5 md:p-4 bg-white/[0.03] hover:bg-white/[0.08] rounded-full text-foreground/60 hover:text-foreground transition-all ring-1 ring-white/10"
            ...
            <div className="flex-1 overflow-y-auto p-4 md:p-10 custom-scrollbar">
              ...
              >
                ...
                <motion.div
                  ...
                  className="lg:col-span-12 xl:col-span-8 rounded-[1.5rem] md:rounded-[3rem] border border-border/20 bg-gradient-to-br from-white/[0.05] to-transparent p-5 md:p-10 xl:p-14 relative overflow-hidden group shadow-2xl"
                >
                  <div className="relative z-10 flex flex-col">
                    <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/[0.03] text-foreground/60 border border-border/20 mb-6 md:mb-10 font-bold text-[10px] md:text-xs uppercase tracking-widest backdrop-blur-md">
                      <Users className="h-3 w-3 md:h-4 md:w-4 text-primary" />
                      <span>Değer Odaklı Gelişim</span>
                    </div>

                    <h3 className="text-2xl md:text-5xl xl:text-6xl font-display font-bold leading-[1.2] md:leading-[1.1] mb-8 md:mb-12 text-foreground max-w-3xl">
                      Gelişim;<br />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
                      <div className="space-y-4 md:space-y-6">
                        <p className="text-base md:text-lg xl:text-xl text-foreground/60 leading-relaxed font-medium">
                          {mainAboutText.split('\n\n')[0]}
                        </p>
                      ...
                      <div className="relative">
                        ...
                        <div className="relative p-6 md:p-8 rounded-[1.5rem] md:rounded-[2rem] bg-foreground/5 border border-border/20 backdrop-blur-2xl shadow-inner">
                          <p className="whitespace-pre-line text-foreground/60 text-sm md:text-base leading-relaxed font-medium italic">
                            "{secondaryAboutText}"
                          </p>
                  ...
                  {cards.map((card, idx) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className={`group relative rounded-[1.5rem] md:rounded-[2.5rem] border border-border/20 bg-gradient-to-br from-white/[0.05] to-transparent p-6 md:p-8 xl:p-10 overflow-hidden transition-all duration-500 hover:border-border/20 hover:shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)]`}
                      >
                        ...
                        <div className="relative z-10 flex flex-col">
                          ...
                          <h4 className="text-xl md:text-3xl font-display font-bold mb-4 md:mb-6 text-foreground group-hover:text-primary transition-colors duration-300">
                            {card.title}
                          </h4>

                          <p className="text-foreground/60 group-hover:text-foreground/60 leading-relaxed font-medium text-sm md:text-base xl:text-lg transition-colors duration-300">
                            {card.description}
                          </p>
